        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
                <div class="sidebar-brand-text mx-3">Karsa App <sup>Company</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseJobs" class="collapse" aria-labelledby="headingJobs"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Job Data Action</h6>
                        <a class="collapse-item" href="/company/job/create">Add Data</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCourses" class="collapse" aria-labelledby="headingCourses"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Course Data Action</h6>
                        <a class="collapse-item" href="/company/course/create">Add Data</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Job Data Action</h6>
                        <a class="collapse-item" href="utilities-color.html">Add Data</a>
                        <a class="collapse-item" href="utilities-border.html">Edit Data</a>
                    </div>
                </div>
            </li>
